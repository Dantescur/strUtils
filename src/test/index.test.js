...
describe("String Utility Functions", () => {
    ...
    describe("truncate", () => {
        ...
        test("should append the specified suffix when truncating", () => {
            expect(stringUtils.truncate("hello world", 5, "... (continued)")).toBe("hello... (continued)");
        });
    });
    describe("startsWith", () => {
    ...
    describe("countOccurrences", () => {
        test("should return the correct number of occurrences of a substring", () => {
            expect(stringUtils.countOccurrences("hello world hello", "hello")).toBe(2);
        });
    ...
    describe("replaceAll", () => {
        test("should replace all occurrences of a substring with a replacement", () => {
            expect(stringUtils.replaceAll("hello world hello", "hello", "hi")).toBe("hi world hi");
        });
    });
    describe("format", () => {
    ...
    describe("toTitleCase", () => {
        test("should convert string to Title Case", () => {
            expect(stringUtils.toTitleCase("hello from title case")).toBe("Hello From Title Case");
        });
    });
});
